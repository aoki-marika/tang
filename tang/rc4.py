class RC4:
    """
    An implementation of the RC4 cipher used for encrypting and decrypting data
    between a Controller and its clients.

    Created by David Buchanan.
    https://github.com/DavidBuchanan314/rc4/blob/master/rc4/rc4.py

    Derived from another implementation by nobody@jpunix.com.
